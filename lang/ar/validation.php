...
return [
    ...
    'attributes' => [
        ...
        'username'              => 'اسم العميل',
        'year'                  => 'السنة',
        'main_hero_img' => 'الصورة الرئيسية',
        'back_hero_img' => 'خلفية الصورة الرئيسية',
        'us_img' => 'صورة من نحن',
        'footer_img' => 'صورة النهاية',
        ...
        'us_status' => 'حالة من نحن',
        'path_status' => 'حالة طريقنا',
        'services_status' => 'حالة خدماتنا',
        'clients_status' => 'حالة عملائنا',
        'team_status' => 'حالة الفريق',
        'footer_status' => 'حالة النهاية',
        'project_sizes' => 'حجوم المشاريع',
        'hero_headline' => 'العنوان الرئيسي',
        'hero_button_text' => 'نص زر الرئيسي',
        'us_headline' => 'عنوان من نحن',
        'us_text' => 'نص من نحن',
        'services_headline' => 'عنوان خدماتنا',
        'services_text' => 'نص خدماتنا',
        'path_headline' => 'عنوان طريقنا',
        'path_text' => 'نص طريقنا',
        'clients_headline' => 'عنوان عملاؤنا',
        'clients_text' => 'نص عملاؤنا',
        'team_headline' => 'عنوان الفريق',
        'team_text' => 'نص الفريق',
