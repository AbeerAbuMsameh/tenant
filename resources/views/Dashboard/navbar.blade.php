...
<div id="kt_header" class="header header-fixed">
    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="topbar">
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-clean btn-lg mr-1" data-toggle="modal" data-target="#kt_rate_modal">
        <span class="svg-icon svg-icon-xl svg-icon-primary">
            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Star.svg-->
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                 height="24px" viewBox="0 0 24 24" version="1.1">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    <polygon points="0 0 24 0 24 24 0 24"/>
                    <path
                        d="M12.1684333,18.1550643 L7.15571806,21.3157287 C6.88187382,21.4898792 6.51545446,21.3577806 6.341304,21.0839363 C6.28940895,21.0010519 6.2612353,20.9084701 6.2612353,20.8130484 L6.2612353,16.128164 L2.3134198,12.8778647 C2.14023914,12.6986943 2.15764414,12.4136437 2.33681457,12.240463 C2.39260681,12.1767447 2.45949433,12.1314962 2.53161008,12.1058502 L7.7336463,10.0938204 L9.34397961,5.44233062 C9.46327071,5.1841116 9.76225725,5.05492489 10.0204762,5.17421599 C10.0841944,5.19840891 10.1410982,5.23884928 10.1849998,5.29175292 L12,8.125 L13.8150002,5.29175292 C13.9366464,5.06242695 14.236046,4.97091349 14.465372,5.0925597 C14.5182757,5.13646134 14.558716,5.19336508 14.582909,5.25708332 L16.192676,9.90857313 L21.3947122,11.9206029 C21.6529312,12.039894 21.7821179,12.3388805 21.662827,12.5970995 C21.6189253,12.6608177 21.5751239,12.715406 21.5312222,12.7628201 L17.5834067,16.0131193 L17.5834067,20.7978304 C17.5834067,20.9003127 17.5318652,21.0010519 17.4300805,21.0829363 C17.2958271,21.1822537 17.0872182,21.1515803 16.9879007,21.0173269 L12.1684333,18.1550643 Z"
                        fill="#000000" fill-rule="nonzero"/>
                </g>
            </svg>
            <!--end::Svg Icon-->
...
<!--begin::Modal-->
<div class="modal fade" id="kt_rate_modal" tabindex="-1" role="dialog" aria-labelledby="rateModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <!-- Modal header -->
            <div class="modal-header">
                <h5 class="modal-title" id="rateModalLabel">Rate The Ticket System</h5>
